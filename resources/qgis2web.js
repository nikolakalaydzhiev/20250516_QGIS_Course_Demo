...
map.getView().fit([533558.931957, 4847106.039811, 546377.275549, 4856366.808563], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Граници от екологичната мрежа "Натура 2000" в обхвата на землището на гр. Русе</h2>';
        return titleElement;
    })(),
